...
module.exports.handleEvent = function({ api, event }) {
  ...
  if ((event.body.toLowerCase() == "bot ơi") ||  (event.body.toLowerCase() == "bot ơi")) {
    return api.sendMessage("Nói lẹ đy, Pòoo còn phải phục vụ các box khác nữa :<<", threadID);
  };
 ...
 if ((event.body.toLowerCase() == "bsvv nha mng") || (event.body.toLowerCase() == "bsvv nha mng")) {
  ...
  if ((event.body.toLowerCase() == "admin m là ai v bot") || (event.body.toLowerCase() == "admin m la ai v bot")) {
    return api.sendMessage("️Admin Pò là Thành daddy có gì dùng lệnh /ad để biết thêm chi tiết", threadID);
  };

  if ((event.body.toLowerCase() == "chán quá") || (event.body.toLowerCase() == "chan qua")) {
    return api.sendMessage("️k sao mà , có Pò đây", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "bot cc") || (event.body.toLowerCase() == "bot cc")) {
    return api.sendMessage("️bye.", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "pò cute quá") || (event.body.toLowerCase() == "po cute qua")) {
  ...
  if ((event.body.toLowerCase() == "pò có yêu em không") || (event.body.toLowerCase() == "po co yeu em khong")) {
    return api.sendMessage("Hi, Bot yêu em hơn cả ny em cơ, yêu bot đi <3", threadID);
  };

  if ((event.body.toLowerCase() == "pò có yêu admin bot không") || (event.body.toLowerCase() == "po co yeu admin bot khong")) {
    return api.sendMessage("KHÔNG, bạn nữ nào có nhu cầu thì cho lun đó", threadID);
  };

  if ((event.body.toLowerCase() == "pò có người yêu chưa") || (event.body.toLowerCase() == "po co nguoi yeu chua")) {
  ...
  if ((event.body.toLowerCase() == "pò có buồn ko") || (event.body.toLowerCase() == "po co buon ko")) {
    return api.sendMessage("Có mọi người sao bé buồn đc <3 yêu lắm <3", threadID);
  };

  if ((event.body.toLowerCase() == "pò có yêu t ko") || (event.body.toLowerCase() == "po co yeu t ko")) {
    return api.sendMessage("Dạ có yêu cậu và mọi người nhiều lắm", threadID);
  };

  if ((event.body.toLowerCase() == "pò đi ngủ đi") || (event.body.toLowerCase() == "po di ngu di")) {
